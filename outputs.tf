output "management_group_policy_exemptions_id" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.id if v.id != null && length(v.id) > 0 }
}
output "management_group_policy_exemptions_description" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.description if v.description != null && length(v.description) > 0 }
}
output "management_group_policy_exemptions_display_name" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.display_name if v.display_name != null && length(v.display_name) > 0 }
}
output "management_group_policy_exemptions_exemption_category" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.exemption_category if v.exemption_category != null && length(v.exemption_category) > 0 }
}
output "management_group_policy_exemptions_expires_on" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.expires_on if v.expires_on != null && length(v.expires_on) > 0 }
}
output "management_group_policy_exemptions_management_group_id" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.management_group_id if v.management_group_id != null && length(v.management_group_id) > 0 }
}
output "management_group_policy_exemptions_metadata" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.metadata if v.metadata != null && length(v.metadata) > 0 }
}
output "management_group_policy_exemptions_name" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.name if v.name != null && length(v.name) > 0 }
}
output "management_group_policy_exemptions_policy_assignment_id" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.policy_assignment_id if v.policy_assignment_id != null && length(v.policy_assignment_id) > 0 }
}
output "management_group_policy_exemptions_policy_definition_reference_ids" {
  ...
  value       = { for k, v in azurerm_management_group_policy_exemption.management_group_policy_exemptions : k => v.policy_definition_reference_ids if v.policy_definition_reference_ids != null && length(v.policy_definition_reference_ids) > 0 }
}
